...
type
	CMBitmapCallBackProcPtr = function( progress: SIGNEDLONG; refCon: UnivPtr ): Boolean;
...
function InvokeCMBitmapCallBackUPP( progress: SIGNEDLONG; refCon: UnivPtr; userUPP: CMBitmapCallBackUPP ): Boolean; external name '_InvokeCMBitmapCallBackUPP';

{$endc} {TARGET_OS_MAC}
{$ifc not defined MACOSALLINCLUDE or not MACOSALLINCLUDE}

end.{$endc} {not MACOSALLINCLUDE}
