...
function QLThumbnailImageCreate( allocator: CFAllocatorRef; url: CFURLRef; maxThumbnailSize: CGSize; options: CFDictionaryRef ): CGImageRef; external name '_QLThumbnailImageCreate';
...
var kQLThumbnailOptionIconModeKey: CFStringRef; external name '_kQLThumbnailOptionIconModeKey'; (* attribute const *)
...
var kQLThumbnailOptionScaleFactorKey: CFStringRef; external name '_kQLThumbnailOptionScaleFactorKey'; (* attribute const *)
